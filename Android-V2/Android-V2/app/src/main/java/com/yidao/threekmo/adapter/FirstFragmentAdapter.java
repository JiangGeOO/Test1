...
public class FirstFragmentAdapter extends BaseRvAdapter<MainHomeListItem> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.item_first_fragment, parent, false);
        ...
        final ViewHolder viewHolder = (ViewHolder) holder;
            ...
            if (null != mainHomeListItem) {
                ...
                if (!TextUtils.isEmpty(mainHomeListItem.getPhoto())) {
                    AppImage.INSTANCE.load(viewHolder.ivImage, mainHomeListItem.getPhoto(), 22, 690, 370);
                } else {

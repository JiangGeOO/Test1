...
public class SetPsdActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setPsd(){
        Call<BaseResult> call = RetrofitUtils.getRetrofit().create(UserServer.class).setPsdFirst(num,psd1,null);
        addCall(call);
        call.enqueue(new Callback<BaseResult>() {
            ...
            public void onResponse(Call<BaseResult> call, Response<BaseResult> response) {
                ...
                if(body.getRspCode() == 0){
                    SuccessToast.showToast("设置成功",false,SetPsdActivity.this);
                    finish();
                }else {
                    ToastUtil.showToast(body.getRspMsg(),false,SetPsdActivity.this);
                }
            }

            @Override
            public void onFailure(Call<BaseResult> call, Throwable t) {
                ToastUtil.showToast(t.getMessage(),false,SetPsdActivity.this);
            }
        });
    }

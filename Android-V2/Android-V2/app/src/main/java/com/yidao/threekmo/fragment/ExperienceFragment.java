...
public class ExperienceFragment extends BaseFragment{
    ...
    public static final ExperienceFragment newInstance(String title) {
    ...
    private void initViews() {
        ...
        //http://192.168.0.83:8081/interior/manage/activity/expArea
        String token = LoginUtils.getToken(getActivity());
        url = WebParameters.SERVERURL + "interior/manage/activity/expArea";
        webview.loadUrl(url);

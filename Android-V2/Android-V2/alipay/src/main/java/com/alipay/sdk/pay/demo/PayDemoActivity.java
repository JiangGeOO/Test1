...
public class PayDemoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rsa_private = bundle.getString("rsa_private");  //  can't be null if sign is null
        partner = bundle.getString("partner");
        seller = bundle.getString("seller");
        notify_url = bundle.getString("notify_url");
        total_fee = bundle.getString("total_fee");  //  total fee
        body = bundle.getString("body");            //  goods detail
        subject = bundle.getString("subject");     //  goods name
        payCode = bundle.getString("payCode");     //  order code
        sign = bundle.getString("sign");        //  can be null
        payInfo = bundle.getString("payInfo");        //  can be null
